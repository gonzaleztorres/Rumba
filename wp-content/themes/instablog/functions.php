...
function instablog_scripts() {
	...
	/* Register Styles */
	wp_register_style( 'instablog-foundation-normalize', get_template_directory_uri() . '/stylesheets/main_style/normalize.css',array(), true ); //Foundation Normalize
	wp_register_style( 'instablog-foundation-css', get_template_directory_uri() . '/stylesheets/main_style/foundation.css',array(), true  ); //Foundation
	...
	wp_enqueue_style( 'instablog-foundation-css' ); 
	...
	include get_template_directory().'/stylesheets/main_style/instablog-dynamic-css.php';
