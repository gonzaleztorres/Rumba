...
function instablog_customize_register( $wp_customize ) {
	...
	*/
	...
	$wp_customize->add_panel( 'homepage_setting_panel', array( // General Panel
	    ...
	    'title'          => esc_html__('Home Page', 'instablog'),
	    'description'    => esc_html__('Changes the home page settings', 'instablog'),
	));
	...
	$wp_customize->add_setting(
    'home_page_post_display_setting_small',
    array(
        'sanitize_callback' => 'instablog_sanitize_dropdown_general',
        )
    );
	$wp_customize->add_control( new instablog_Post_Dropdown( $wp_customize, 'home_page_post_display_setting_small',
	    array(
	...
	$wp_customize->add_setting(
    'home_page_post_display_setting_large',
    array(
        'sanitize_callback' => 'instablog_sanitize_dropdown_general',
        )
    );
	$wp_customize->add_control( new instablog_Post_Dropdown( $wp_customize, 'home_page_post_display_setting_large',
	    array(
	...
	*/
	...
	$wp_customize->add_control( 'show_footer_text', array(
		'label'    => esc_html__( 'Hide Footer text', 'instablog' ),
